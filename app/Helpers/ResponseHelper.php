...
class ResponseHelper
{
    ...
    const HTTP_INCORRECT_PIN = 440;
    const HTTP_FAILED_UPDATE_VOUCHER = 441;
    const HTTP_ALREADY_REDEEM_DAILY = 442;
    const HTTP_FAILED_GET_CUSTOMER_ID = 443;
    const HTTP_FAILED_GET_MEMBER_DATA = 444;
    const HTTP_OUT_OF_STOCK = 445;
    #End
